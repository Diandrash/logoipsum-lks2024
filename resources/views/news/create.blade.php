...
@section('container')
    <section class="mx-10 pb-20">
        <h1 class="font-semibold text-2xl">Create New Article</h1>
        ...
        <form action="/myarticles/create" method="post" enctype="multipart/form-data">
            ...
            <div class="input-area mt-5">
                ...
                <input name="title" type="text" class="font-semibold mt-2 w-full text-lg h-16 pl-3 rounded-md" placeholder="Article Title Here" value="{{ old('title') }}">
                @error('title')
            ...
            <div class="input-area mt-5">
                ...
                <input name="slug" type="text" class="font-semibold mt-2 w-full text-lg h-16 pl-3 rounded-md" placeholder="Article slug Here" value="{{ old('slug') }}">
                @error('slug')
                    <h1 class="mt-2 text-red-600">{{ $message }}</h1>
                @enderror
            </div>
